...
class ChatbotWidget {
    ...
    getPageContext() {
        ...
        if (window.GARUDAX_PAGE_CONTEXT) {
            return { ...context, ...window.GARUDAX_PAGE_CONTEXT };
        }
    ...
    createWidget() {
        ...
        widget.innerHTML = `
            <!-- Toggle Button -->
            <button class="chatbot-toggle" id="chatbot-toggle" title="GarudaX AI Assistant">
            ...
            <div class="chatbot-window" id="chatbot-window">
                ...
                <div class="chatbot-header">
                    ...
                    <div class="chatbot-header-info">
                        <h3 class="chatbot-header-title">GarudaX AI</h3>
                ...
                <div class="chatbot-messages" id="chatbot-messages">
                    <div class="chatbot-message assistant">
                        👋 Hello! I'm your GarudaX Security AI Assistant. I can help you with:
                        <ul>
